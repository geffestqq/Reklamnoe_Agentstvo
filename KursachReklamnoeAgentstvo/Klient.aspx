<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Klient.aspx.cs" Inherits="KursachReklamnoeAgentstvo.Klient" %>
    ...
    <path fill="currentColor"
      d="M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z">
        ...
        <script>
         ...
         <asp:SqlDataSource ID="sdsKlient" runat ="server"></asp:SqlDataSource>
        <div>
             <Center>
             <asp:GridView ID ="gvKlient" runat ="server" AllowSorting ="true" Font-Size ="16"  
                     Font-Names ="Arial" CssClass="td" OnRowDataBound="gvKlient_RowDataBound" 
                     OnSelectedIndexChanged="gvKlient_SelectedIndexChanged" 
                     OnSorting="gvKlient_Sorting" ForeColor="Black" BackColor="#CCFF33"    >
            ...
            <left>
             ...
             <asp:Button ID="Button2" runat="server" Height="37px" 
                ...
                <br />
                 ...
                 Text ="Имя:" Font-Size="24pt" ForeColor="White"></asp:Label>   
                 ...
                 Text ="Фамилия:" Font-Size="24pt" ForeColor="White"></asp:Label>   
             ...
             <br />
                 ...
                 Text ="Отчество:" Font-Size="24pt" ForeColor="White"></asp:Label>   
                     
             <asp:TextBox ID="TextBox5" runat="server" Height="31px" 
                 style="margin-left: 6px" Width="336px"></asp:TextBox>
             <br />
                     <asp:Label ID ="Label6" runat="server" CssClass="Texting" 
                 Text ="Номер телефона:" Font-Size="24pt" ForeColor="White"></asp:Label>   
                     
             <asp:TextBox ID="TextBox6" runat="server" Height="31px" 
                 style="margin-left: 6px" Width="336px"></asp:TextBox>
             <br />
                     <asp:Label ID ="Label7" runat="server" CssClass="Texting" 
                 Text ="Почта:" Font-Size="24pt" ForeColor="White"></asp:Label>   
                     
             <asp:TextBox ID="TextBox7" runat="server" Height="31px" 
                 style="margin-left: 6px" Width="336px"></asp:TextBox>
             <br />
             <br />
                     <asp:Label ID ="Label4" runat="server" CssClass="Texting" Text ="Логин:" 
                 Font-Size="24pt" ForeColor="White"></asp:Label>   
